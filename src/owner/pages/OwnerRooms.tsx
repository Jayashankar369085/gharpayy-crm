    ...
    <div className="space-y-5 pb-32">
      <header className="flex items-end justify-between flex-wrap gap-2">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Confirm rooms anytime today. Warnings go at 11 AM, 2 PM and 7 PM before any 10 PM lock.</p>
        </div>
                ...
                return (
                  <div key={s.roomId} className={cn('rounded-xl border bg-card overflow-hidden flex flex-col', tone)}>
                    ...
                    <div className="p-3 space-y-2 flex-1 flex flex-col">
                      ...
                      {s.lockedUnsellable && (
                        <div className="text-[11px] text-destructive font-medium">⚠ Auto-locked — not verified after 3 warnings</div>
                      )}
