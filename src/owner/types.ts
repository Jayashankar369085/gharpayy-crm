...
export interface OwnerRoomStatus {
  ...
  lockedUnsellable: boolean; // auto-flipped after the 10 PM warning cycle if not verified
...
export type DailyTruthPhase = 'idle' | 'open' | 'warning' | 'warning2' | 'warning3' | 'locked';
