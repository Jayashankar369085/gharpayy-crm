      ...
      <div className="max-w-3xl space-y-8">
        ...
        <section className="space-y-3">
          ...
          <ol className="space-y-3">
            ...
            <Step time="11 AM · 2 PM · 7 PM" title="Three owner warnings" body="Owners get three reminders to confirm rooms without killing supply in one go." />
            <Step time="10:00 PM" title="End-of-day lock" link={{ to: '/owner/rooms', label: 'View rooms' }}
