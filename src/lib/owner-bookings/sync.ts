// Smart-sync: build a booking draft from existing lead / property / quotation data.
...
export interface BookingDraft {
  ...
  /** Field-level provenance — drives "Synced from X" badges in the UI. */
...
export function emptyDraft(): BookingDraft {
  return {
    ...
    ownerId: "",
    rent: 12000, deposit: 24000, bookingAmt: 5000, otherCharges: 0,
    moveIn: {
...
export function applyQuotation(d: BookingDraft, q: Quotation | undefined): BookingDraft {
  ...
  // Lock-in & notice from quotation strings like "3 Months", "30 Days"
