...
/** PTQ — Post Tour Qualification scorecard. */
export type PTQFit = "perfect" | "partial" | "poor";
export type PTQBudgetFit = "comfortable" | "stretch" | "objection";
export type PTQLocationFit = "perfect" | "acceptable" | "concern" | "rejected";
export type PTQDecisionReadiness =
  | "self-now" | "parent-pending" | "group-pending" | "company-pending";
export type PTQMoveInUrgency = "immediate" | "7d" | "15d" | "future";
export type PTQBucket = "A" | "B" | "C" | "D" | "E";
export type PTQObjection =
  | "budget" | "location" | "parent" | "room" | "amenities" | "competition" | "none";

export interface PTQScore {
  propertyFit?: PTQFit;
  budgetFit?: PTQBudgetFit;
  locationFit?: PTQLocationFit;
  decisionReadiness?: PTQDecisionReadiness;
  moveInUrgency?: PTQMoveInUrgency;
  propertyRating?: number;          // 1-10
  bookingProbability?: number;      // 0-100
  biggestObjection?: PTQObjection;
  expectedBookingDate?: string;     // ISO
}
