...
/**
 * Stage-aware cluster of WhatsApp copy chips. Same component drops into
 * the list row's inline action area AND the detail panel.
 */
export function VisitCopyChips({
  ...
  // Always show owner ping at the end — flow-ops/owner needs it any stage.
  items.push({
    label: "Owner ping",
