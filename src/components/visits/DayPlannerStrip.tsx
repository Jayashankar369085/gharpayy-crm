...
/**
 * Horizontal 24h ribbon, one swim-lane per TCM with a colored block for
 * every visit. The "Now" line auto-scrolls into view. Click a block →
 * focuses that visit in the parent detail panel.
 */
...
export function DayPlannerStrip({
  ...
  // Compute hour range from earliest scheduled-1h to latest+2h, clamped 6..23
