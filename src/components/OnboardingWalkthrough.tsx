...
const STEPS = [
  ...
  {
    title: '1. Owners update rooms with 3 warnings',
    body: 'Daily Truth: 9:30 AM open · reminders at 11 AM, 2 PM and 7 PM · 10 PM lock only after warnings.',
...
export function OnboardingWalkthrough() {
  ...
  useEffect(() => {
    ...
    if (window.location.pathname === '/impact' || window.location.pathname.startsWith('/owner')) return;
